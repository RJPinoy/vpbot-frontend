            ...
            <form className="w-full flex flex-col gap-4 mt-8">
                <div className="flex justify-start items-center flex-row gap-8 w-full">
                    <div className="flex flex-col w-1/2">
                        ...
                        <input className="border rounded px-2 py-1 mt-1" type="text" name="firstName" onChange={ handleInputChange } value={ firstName } />
                    </div>
                    <div className="flex flex-col w-1/2">
                        <label htmlFor="lastName">Nom :</label>
                        <input className="border rounded px-2 py-1 mt-1" type="text" name="lastName" onChange={ handleInputChange } value={ lastName } />
                    </div>
                </div>
                <div className="flex justify-start items-start flex-row gap-8 w-full mb-4">
                    <div className="flex justify-start items-center flex-col gap-4 w-1/2">
                        <div className="flex flex-col w-full">
                            ...
                            <input className="border rounded px-2 py-1 mt-1" type="text" name="username" onChange={ handleInputChange } value={ username } />
                        </div>
                        <div className="flex flex-col w-full">
                            <label htmlFor="email">Email :</label>
                            <input className="border rounded px-2 py-1 mt-1" type="email" name="email" onChange={ handleInputChange } value={ email } />
                        </div>
                    </div>
                    <div className="flex flex-col w-1/2">
